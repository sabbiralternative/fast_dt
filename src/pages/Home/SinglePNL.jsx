        ...
        >
          <div className="w-full p-4 border rounded-lg bg-zinc-900 border-zinc-800">
            ...
            <div className="relative w-full -mt-20 pointer-events-none aspect-square">
              ...
              >
                {singlePNL?.card_dragon?.suit === "H" && (
                  <Heart rank={singlePNL?.card_dragon?.rank} />
                )}
                {singlePNL?.card_dragon?.suit === "C" && (
                  <Club rank={singlePNL?.card_dragon?.rank} />
                )}
                {singlePNL?.card_dragon?.suit === "S" && (
                  <Spade rank={singlePNL?.card_dragon?.rank} />
                )}
                {singlePNL?.card_dragon?.suit === "D" && (
                  <Diamond rank={singlePNL?.card_dragon?.rank} />
                )}
              </div>
              <div
                className={` ${
                  singlePNL?.winner === "Tiger"
                    ? "border-stakeGreen"
                    : "border-zinc-300"
                } relative border-2  shadow-sm  transition-all  ease-in-out duration-200 h-24 lg:h-40  aspect-[5/7] rounded bg-white`}
                style={{
                  position: "absolute",
                  right: "20%",
                  top: "45%",
              ...
              >
                {singlePNL?.card_tiger?.suit === "H" && (
                  <Heart rank={singlePNL?.card_tiger?.rank} />
                )}
                {singlePNL?.card_tiger?.suit === "C" && (
                  <Club rank={singlePNL?.card_tiger?.rank} />
                )}
                {singlePNL?.card_tiger?.suit === "S" && (
                  <Spade rank={singlePNL?.card_tiger?.rank} />
                )}
                {singlePNL?.card_tiger?.suit === "D" && (
                  <Diamond rank={singlePNL?.card_tiger?.rank} />
                )}
              </div>
