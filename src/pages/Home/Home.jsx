      ...
      <div className="flex flex-col flex-grow w-full lg:overflow-y-auto lg:flex-row-reverse bg-zinc-800">
        ...
        >
          <div className="flex items-center w-full gap-2 text-white">
            ...
            >
              <span className="px-3 py-1 animate__animated rounded-full border border-transparent cursor-pointer font-semibold bg-stakeGreen/5 text-stakeGreen hover:border-stakeGreen z-50">
                Dragon
              </span>
              <span className="px-3 py-1 animate__animated rounded-full border border-transparent cursor-pointer font-semibold bg-stakeGreen/5 text-stakeGreen hover:border-stakeGreen z-50">
                Dragon
